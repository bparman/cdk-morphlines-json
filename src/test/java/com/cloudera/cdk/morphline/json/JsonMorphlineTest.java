...
public class JsonMorphlineTest extends AbstractMorphlineTest {
  ...
  @Test
  public void testWellsTXTMorphline() throws Exception {
    morphline = createMorphline("test-morphlines/ml2");    
    File file = new File(RESOURCES_DIR + "/test-documents/msg-TXT3.out");
